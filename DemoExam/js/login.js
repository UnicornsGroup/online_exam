window.addEventListener('DOMContentLoaded', () => {
    ...
    loginForm.addEventListener('submit', async (e) => {
        ...
        // ⚡ DYNAMIC UPDATE: Fallback to global config settings to avoid cross-contamination
        const uiSettings = window.clientPortalSettings;
        const targetSuffix = (uiSettings && uiSettings.emailDomainSuffix) ? uiSettings.emailDomainSuffix : "portal.com";
        const derivedEmail = `${rawUsername}@${targetSuffix}`;
